...
<div class="main-container row mx-auto">
    ...
    <div class="post-section bg-light col-12 col-md-9">
        <h2 class="font-weight-bold">Welcome <?php echo $_POST["firstname"]; ?></h2>
        <p>These are hotels in <span class="font-weight-bold"><?php echo $_POST["state"]; ?></span> specially recommended for you based on your <span class="font-weight-bold"><?php echo $_POST["occupation"]; ?></span> profession. </p>
        ...
        $sql = "SELECT name, description, image, url FROM hotels WHERE state='$state' AND occupation='$occupation'";
